...
ASimpleShooterCharacter::ASimpleShooterCharacter()
{
	...
	InteractionComponent = CreateDefaultSubobject<USSInteractionComponent>(TEXT("InteractionComponent"));
	ActionComponent = CreateDefaultSubobject<USSActionComponent>(TEXT("ActionComponent"));
	AttributeComponent = CreateDefaultSubobject<USSAttributeComponent>(TEXT("AttributeComponent"));
...
void ASimpleShooterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (USSEnhancedInputComponent* EnhancedInputComponent = Cast<USSEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAbilityAction(InputConfig, this, &ThisClass::ActionInputTagPressed, &ThisClass::ActionInputTagReleased);
	}
	else
	{
...
void ASimpleShooterCharacter::ActionInputTagReleased(FGameplayTag InputTag)
{
	ActionComponent->StopActionByTag(this, InputTag);
}
